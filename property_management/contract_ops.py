...
def show_sozlesme_menu(root, show_main_menu_cb):
    ...
    tk.Label(main_frame, text=" SÖZLEŞME OLUŞTUR", font=("Arial", 18, "bold"), bg='#1e1e1e', fg='white').pack(pady=20)
    ...
    if not emlaklar or not musteriler:
        ...
        tk.Label(main_frame, text=warning_text, font=("Arial", 14, "bold"),
                 bg='#1e1e1e', fg='red', justify=tk.CENTER).pack(pady=50)
    ...
    tk.Radiobutton(radio_frame, text=" Kira Sözleşmesi", variable=sozlesme_turu, value="Kira",
                   bg='#334155', fg='white', font=("Arial", 12), selectcolor='#1e1e1e').pack(side=tk.LEFT, padx=30)
...
═══════════════════════════════════════════════
    ...
    create_modern_button(btn_frame, " Sözleşme Oluştur", olustur_sozlesme, "#4f4f4f", width=25, height=4).pack(side=tk.LEFT, padx=20)
    create_modern_button(btn_frame, " Ana Menü", lambda: show_main_menu_cb(root), "#5c5c5c", width=25, height=4).pack(side=tk.LEFT, padx=20)
